...
export const GLOSSARY_CATEGORY_TO_TOPIC: Record<string, { href: string; label: string }> = {
  "Profitability Ratios": { href: "/vault/guides/profitability-ratios", label: "Profitability Ratios" },
  "Valuation Ratios": { href: "/vault/guides/market-ratios", label: "Market Ratios" },
  "Liquidity Ratios": { href: "/vault/guides/liquidity-ratios", label: "Liquidity Ratios" },
  "Solvency Ratios": { href: "/vault/guides/solvency-ratios", label: "Solvency Ratios" },
  "Efficiency Ratios": { href: "/vault/guides/efficiency-ratios", label: "Efficiency Ratios" },
  "Technical Analysis": { href: "/vault/guides/technical-analysis-primer", label: "Technical Analysis Primer" },
  "Investment Planning": { href: "/vault/guides/time-value-of-money", label: "Time Value of Money" },
  "Risk & Portfolio": { href: "/vault/guides/mutual-funds-etfs-aifs", label: "Mutual Funds, ETFs, AIFs" },
  "Fundamentals": { href: "/vault/guides/reading-an-income-statement", label: "Reading an Income Statement" },
  "Mutual Funds": { href: "/vault/guides/mutual-funds-etfs-aifs", label: "Mutual Funds, ETFs, AIFs" },
  "Indices": { href: "/vault/guides/equities", label: "Equities (NSE, BSE, IPO Process)" },
  "Basics of Stock Market": { href: "/vault/guides/equities", label: "Equities (NSE, BSE, IPO Process)" },
  "Regulatory Compliance": { href: "/vault/guides/equities", label: "Equities (NSE, BSE, IPO Process)" },
  "Credit & Debt": { href: "/vault/guides/bond-pricing-and-yields", label: "Bond Pricing and Yields" },
  "Macroeconomics": { href: "/vault/guides/debt-markets-and-yield-curves", label: "Debt Markets and Yield Curves" },
  "ESG & Governance": { href: "/vault/guides/esg-fundamentals", label: "ESG Fundamentals" },
  "Fintech": { href: "/vault/guides/payments-landscape", label: "Payments Landscape" },
};

...
export const SECTIONS: Section[] = [
  {
    ...
    inNav: true,
    subsections: [
      { id: "business-news", label: "Business News", description: "What Indian businesses are doing, and what it means for their numbers." },
      { id: "markets-news", label: "Markets News", description: "Indices, sectors, flows, and the constituents that carry the market." },
      { id: "economy-policy", label: "Economy & Policy", description: "Growth, inflation, the RBI, SEBI, and exchange circulars, with the compliance calendar." },
      { id: "corporate-news", label: "Corporate News", description: "Results, capital raises, and corporate actions worth a second look." },
      { id: "esg-news", label: "ESG & Sustainability News", description: "Green finance, disclosure rules, and governance developments as they happen." },

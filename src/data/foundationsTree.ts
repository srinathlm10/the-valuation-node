// The Concept Guide tree: nine tracks (former Foundations sections), 51 topics.
// Moved out of pages/Foundations.tsx in the restructure so routes, hubs and the
// sitemap can import it without pulling in a page component.
...
export type FoundationsSection = (typeof FOUNDATIONS_TREE)[number];
export type FoundationsTopic = FoundationsSection["topics"][number];

export function findTopic(slug: string): { section: FoundationsSection; topic: FoundationsTopic } | undefined {

...
export const routes: RouteRecord[] = [
  {
    ...
    children: [
      ...
      { path: "analysis/valuation-modeling", element: <LegacyRedirect /> },
      { path: "analysis/op-eds", element: <LegacyRedirect /> },
      { path: "analysis/business-strategy", element: <LegacyRedirect /> },
      { path: "analysis/case-studies", element: <LegacyRedirect /> },

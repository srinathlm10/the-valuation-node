...
export default function ReadIncomeStatementPage() {
  return (
    <Layout>
      ...
      />
      <Breadcrumbs items={[{ name: "The Vault", path: "/vault" }, { name: "Interactive", path: "/vault/interactive" }, { name: "Read an Income Statement, Line by Line", path: "/vault/interactive/read-an-income-statement" }]} />
      ...
      <div className="container max-w-5xl py-10">
        ...
        <h2 className="sr-only">Lesson</h2>

  ...
  return (
    <Layout>
      <Seo
        ...
        jsonLd={[breadcrumbLd([{ name: "The Vault", path: "/vault" }, { name: "Interactive", path: "/vault/interactive" }, { name: "DCF Sensitivity Calculator", path: "/vault/interactive/dcf-sensitivity" }])]}
      />

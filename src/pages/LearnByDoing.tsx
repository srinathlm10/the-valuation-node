...
const modules = [
  ...
  },
  {
    ...
    description: "Walk through a real Nifty 50 company's P&L, line by line, and understand what each number means.",
    duration: "~20 min",
    steps: null,
  },
  {
    ...
    description: "Pull numbers from financial statements and compute the ratios analysts use every day.",
    duration: "~25 min",
    steps: null,
  },
  {
    ...
    description: "Use a structured framework to compare two companies in the same sector.",
    duration: "~15 min",
    steps: null,
  },
  {
    ...
    description: "Work through a set of real financial statements and identify warning signs of financial distress.",
    duration: "~30 min",
    steps: null,
  },
];
